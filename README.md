...
Populating the pads is up to you - I'm using a 15k / 1k potential divider for the -24dB and 3k3 / 1k1 potential divider for the -12dB. HOWEVER, you should remember that the device you're plugging into has finite (and probably LOW) input impedance, which will sit in parallel with the botttom reisistor of the potential divider, so either don't take the open-circuit calculations too seriosly, or account for this loading in your design!
